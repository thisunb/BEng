...
class RiceAndGrains extends React.Component {
    ...
    render() {
        ...
        for(var i = 0; i < priceData.length; i++){
            if(priceData[i]["item_type"] == "riceGrain") {
                ...
                <div id="page">
                    <div className='dashboard-body-wrapper'>
                        <div className='dashboard-body'>
                            <div className="dashboard-heading-text"> Rice & Grains</div>
                            {
                                ...
                                :<div className='no-added-message'>Price forecasts for rice & grains are currently not available!</div>
                            }
                        </div>
                    </div>
                </div>
