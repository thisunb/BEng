                ...
                <div id="page">
                    <div className='dashboard-body-wrapper'>
                        <div className='dashboard-body'>
                            <div className="dashboard-heading-text"> Vegetables</div>
                            {
                                ...
                                :<div className='no-added-message'>Price forecasts for vegetables are currently not available!</div>
                            }
                        </div>
                    </div>
                </div>
