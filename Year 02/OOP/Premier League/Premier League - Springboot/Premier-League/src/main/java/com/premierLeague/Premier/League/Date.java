...
public class Date {
    ...
    public Date(){                                                                  // Creating the default constructor

    }

    public Date (int year, int month, int day){                                      // Creating the second constructor
        this.year = year;
        this.month = month;
        this.day = day;
    }
    ...
    public void dateCheckGui(){                         // Validating random generated values for date in GUI component
